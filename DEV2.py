...
def optimize():
    ...
    while (it<Evaluation_number):
      ...
      F_P,mu_by_dimension,index_mu_by_dimension = DE.Generate_F_parameter(difference_fitness,D,F_P,NP,Nb_successful_parameters,SF_P,mu_by_dimension,index_mu_by_dimension,mu_archive_size,Successful_parents)
